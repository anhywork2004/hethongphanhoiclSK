...
// 16. Homepage Settings Table (Dynamic CMS for Landing Page)
export const homepageSettings = sqliteTable("homepage_settings", {
  id: text("id").primaryKey(), // Default 'main'
  heroTitle: text("hero_title").notNull(),
  heroSubtitle: text("hero_subtitle").notNull(),
  bannerImageUrl: text("banner_image_url"),
  kpiMetricsJson: text("kpi_metrics_json"), // JSON for custom 4 KPI cards
  workshopsJson: text("workshops_json"), // JSON for workshop showcase
